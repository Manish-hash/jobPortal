                ...
                <div class="card border-0 shadow p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check mb-2"> 
                            <input class="form-check-input " name="jobType" type="checkbox" value="1" id="jobType">    
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bg-light p-3 border">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <span class="ps-1">NPR {{ $job->salary }}</span>
                                        </p>
                                        @endif
                                    </div>
...
<section class="section-3 py-5 bg-2">
    <div class="container">     
        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action="{{ route('jobs.index') }}" method="GET" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                        ...
                        <div class="mb-4">
                            ...
                            @if($job_types->isNotEmpty())
                                @foreach($job_types as $job_type)
                                    <div class="form-check mb-2"> 
                                        <input {{ (in_array($job_type->id, $jobTypeArray)) ? 'checked' : '' }} class="form-check-input" name="jobType[]" type="checkbox" value="{{ $job_type->id }}" id="jobType{{ $job_type->id }}">    
                                        <label class="form-check-label" for="jobType{{ $job_type->id }}">{{ $job_type->name }}</label>
                                    </div>
                                @endforeach
                            @endif
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">Search</button>
                        <a href="{{ route('jobs.index') }}" class="btn btn-secondary mt-3">Reset</a>
                    </div>
                </form>
            </div>
